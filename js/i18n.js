const i18n = {
    en: {
        ...
        changeToExisting: "Change to Existing Product",
        save: "Save",
        cancel: "Cancel",
        ...
        confirmDeleteCategory: "Are you sure you want to delete this category? All related products will be deleted too.",
        ...
        location: "Location",
        address: "Address",
        assignUserToBranch: "Assign User to Branch",
        assignedUsers: "Assigned Users",
        accessLevel: "Access Level",
        fullAccess: "Full Access (Edit/Approve)",
        viewOnly: "View Only",
        user: "User",
        assign: "Assign",
        branch: "Branch",
    ...
    ar: {
        ...
        changeToExisting: "تغيير لمنتج موجود",
        save: "حفظ",
        cancel: "إلغاء",
        editCategory: "تعديل الصنف",
        editProduct: "تعديل المنتج",
        categoryRequired: "الصنف مطلوب",
        nameRequired: "الاسم مطلوب",
        confirmDeleteCategory: "هل أنت متأكد من حذف هذا الصنف؟ سيتم حذف جميع المنتجات المرتبطة به أيضاً.",
        ...
        location: "الموقع",
        address: "العنوان",
        assignUserToBranch: "تعيين مستخدم لفرع",
        assignedUsers: "المستخدمون المعينون",
        accessLevel: "مستوى الصلاحية",
        fullAccess: "صلاحية كاملة (تعديل/اعتماد)",
        viewOnly: "عرض فقط",
        user: "المستخدم",
        assign: "تعيين",
        branch: "الفرع",
