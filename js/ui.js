...
const ui = {
    ...
    updateUserUI(user) {
        ...
        if (role !== 'admin') {
            document.getElementById('link-admin').classList.add('d-none');
        }
        if (role === 'employee') {
            document.getElementById('link-approvals').classList.add('d-none');
            document.getElementById('link-all-requests').classList.add('d-none');
            document.getElementById('link-reports').classList.add('d-none');
        }
        if (role === 'it_procurement' || role === 'finance') {
             // Re-viewers see approvals
        }
    },
